...
export const APPROACH_TYPE_DEFINITIONS: readonly ClassificationDefinition[] = [
  ...
  { id: 'agent-system', label: 'Agent family', meaning: 'A documented family of independently useful agents; internal subagents alone do not establish a family.' },
  ...
  { id: 'supporting-pattern', label: 'Component', meaning: 'A narrower implemented component that enables agent operation.' },
];
