...
- [x] All published URL and format contracts above pass deployed verification.
...
- [x] Design/browser acceptance, release revision, and rollback details are
  recorded. Search measurement is completed or assigned to the site owner.
- [x] Documentation and `plans/README.md` reflect the final implemented state.
